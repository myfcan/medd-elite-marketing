    ...
    <section id="sobre" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          <div className="relative bg-white border-2 border-red-200 rounded-3xl p-12 text-center">
            <div className="mb-8">
              <div className="text-7xl lg:text-8xl font-bold bg-gradient-to-r from-red-500 to-red-600 bg-clip-text text-transparent mb-6">
                87%
              </div>

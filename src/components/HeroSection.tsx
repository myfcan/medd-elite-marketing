        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[60vh] sm:min-h-[70vh]">
          ...
          <div className="flex justify-center lg:justify-end animate-scale-in mt-10">
            <div className="relative">
              {/* Floating Elements */}
              <div className="absolute -top-16 -right-32 bg-white rounded-2xl p-4 shadow-xl border border-gray-100 animate-fade-in" style={{animationDelay: '0.5s'}}>
              ...
              <div className="absolute -bottom-16 -left-32 bg-white rounded-2xl p-4 shadow-xl border border-gray-100 animate-fade-in" style={{animationDelay: '0.7s'}}>
                <div className="flex items-center space-x-3">
